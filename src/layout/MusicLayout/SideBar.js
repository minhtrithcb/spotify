...
const SideBar = ({ toggleSideBar, settoggleSideBar }) => {
    ...
    return (
        ...
        >
            ...
            <div
                className={` hidden lg:block m-4 p-4 text-center 
                ${toggleSideBar && " hidden lg:hidden"} rounded
				bg-gradient-to-r from-green-600 to-teal-600 `}
            >
                <p>
                    Sign in to discover playlists
                    <br /> just for you
                </p>
                <button className='px-5 py-1 mt-2 border rounded-lg'>
                    Login
                </button>
            </div>
        </div>
